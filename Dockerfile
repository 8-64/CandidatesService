...
RUN cpm install --global Plack DBI DBD::SQLite YAML Thrall Gazelle Starman Class::Accessor::Fast Plack::Middleware::Debug Regexp::Common IO::Socket::SSL Log::Log4perl Log::Dispatch::FileRotate JSON::Validator B::Lint
